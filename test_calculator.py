...
class TestCalculator(unittest.TestCase):
    ...
    def test_add(self): # 3 assertions
        ...
        self.assertEqual(add(5.5, 7), 12.5)

    def test_subtract(self): # 3 assertions
        self.assertEqual(subtract(1, 2), -1)
        self.assertEqual(subtract(4, 3), 1)
        self.assertEqual(subtract(-6, -8), 2)
    # ##########################
    ...
    def test_log_invalid_base(self): # 1 assertion
        self.assertEqual(logarithm(4,0),0)
        self.assertEqual(logarithm(8,0),0)
        self.assertEqual(logarithm(10,0),0)
    # ##########################
    ...
    def test_hypotenuse(self):
        ...
        self.assertAlmostEqual(hypotenuse(22, -377), (sqrt((22 ** 2) + (-377 ** 2))))
